...
<h2>Календарь на месяц</h2>
    <form method="post" action="">
        <input type="text" required name="mons">
        <input type="text" required name="years">
        <input type="submit" name="call">
    </form>

<div class="b-calendar b-calendar--along">
    <div class="b-calendar__title"><span class="b-calendar__month">
            <?
            $months = Array(
                0 => 'Январь',
                1 => 'Февраль',
            ...
            echo $months[$_POST['mons']-1];

            ?>
        </span> <span class="b-calendar__year"> <?= $_POST['years'];?></span></div>
    <?
    if (isset($_POST['call'])){
        echo draw_calendar($_POST['mons'],$_POST['years']);
    }
